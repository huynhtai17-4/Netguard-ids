...
class ConfigLoader:
    ...
    def _apply_env_overrides(self) -> None:
        ...
        for key_path, value in flat_config.items():
            ...
            if env_var_name in os.environ:
                ...
                self.logger.debug(f"Overriding {key_path} with environment variable {env_var_name}: {converted_value}")
    ...
    def get(self, key_path: str, default: Any = None) -> Any:
        ...
        try:
            ...
            self.logger.warning(f'Missing config: {key_path}, using default value: {default}')
        return value
